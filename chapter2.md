...
_By the way, if you haven't downloaded it already, check out the [python basics Cheat Sheet](link). It includes an overview of the most important concepts, functions and methods and might come in handy if you ever need a quick refresher!_
