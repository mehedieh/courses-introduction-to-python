...
success_msg("Nice! Notice from the printouts that the [<code>upper()</code>](https://docs.python.org/3/library/stdtypes.html#str.upper) method does not change the object it is called on. This will be different for lists in the next exercise!")
```
